const data = [
    ...
    { image: '/ödev/nav/image4.jpg', description: 'Windows 11 Android desteğini kaybediyor!', url: '/ödev/makaleler/m1.html', url: '/ödev/makaleler/m4.html', url2: '/ödev/makaleler/m4.html' },
